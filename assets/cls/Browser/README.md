_This is not entirely my code; it's a modified version of Chris Schuld's code so people can use it as a submodule in their projects. To download the original code please visit [Chris Schuld's page](http://chrisschuld.com/projects/browser-php-detecting-a-users-browser-from-php/)._
